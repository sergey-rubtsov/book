...
insert into ingredient (id, category, name) values (12, 1, 'Egg');
...
insert into recipe_ingredients (recipe_id, ingredients_id) values (4, 12);
...
insert into ingredient (id, category, name) values (17, 0, 'Kosher salt');
...
insert into recipe_ingredients (recipe_id, ingredients_id) values (5, 17);
...
insert into ingredient (id, category, name) values (27, 0, 'Garlic');
...
insert into recipe_ingredients (recipe_id, ingredients_id) values (6, 27);
...
insert into ingredient (id, category, name) values (33, 0, 'Tomato');
...
insert into recipe_ingredients (recipe_id, ingredients_id) values (7, 33);
...
insert into ingredient (id, category, name) values (39, 0, 'Parmesan cheese');
...
insert into recipe_ingredients (recipe_id, ingredients_id) values (8, 39);

-- Recipe 9: Banana Smoothie
insert into recipe (id, instructions, servings, title) values (9, 'Combine all ingredients in a blender. Blend until smooth', 1, 'Banana Smoothie');
