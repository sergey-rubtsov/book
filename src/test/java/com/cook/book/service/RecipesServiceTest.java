...
class RecipesServiceTest {
    ...
    void updateRecipe() {
        ...
        Recipe updatedByTitle = Recipe.builder()
                ...
                .instructions("Some instruction 2")
                .build();
        updatedByTitle.getIngredients().add(justPotato);
        updatedByTitle.getIngredients().add(schmotato2);
    ...
    void deleteRecipe() {
        ...
        recipe.getIngredients().add(potato);
        recipe.getIngredients().add(schmotato);
        Long id = recipesService.createRecipe(recipe).getId();
        Ingredient justPotato = Ingredient.builder()
                .name("Potato")
                .category(Category.VEGETARIAN)
                .build();
        ...
        recipe2.getIngredients().add(justPotato);
        recipe2.getIngredients().add(meat);
        Long id2 = recipesService.createRecipe(recipe2).getId();
